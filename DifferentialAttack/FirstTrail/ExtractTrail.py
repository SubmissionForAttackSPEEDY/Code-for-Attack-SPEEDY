...
def ExtractTrail_i(infileName, outfileName, StartRound, StartTag, EndRound, EndTag, SboxLoc, AllP):
...
def ExtractTrail(infileName, outfileName, StartRound, StartTag, EndRound, EndTag):
    ...
    for SboxLoc in range(32):
        ExtractTrail_i(infileName, outfileName, StartRound, StartTag, EndRound, EndTag, SboxLoc, AllP)
...
infileName = "SPEEDY_Differential_FirstTrail.txt"
outfileName = "out_SPEEDY_Differential_FirstTrail.txt"
StartRound = 1
StartTag = 3
EndRound = 3
EndTag = 4
